              ...
              <div className="carousel-inner">
                <div className="item active ">
                  <div className="profile-circle">
                    <a href="/news_detail/index/MQ"><img src={NewsImg} alt /></a>
                  </div>
                  <blockquote>
                ...
                <div className="item ">
                  <div className="profile-circle">
                    <a href="/news_detail/index/Mg"><img src={NewsImg} alt /></a>
                  </div>
                  <blockquote>
            ...
            <div className="Add">
              <div className="scroll">
                <div className="ScrollBlock">
                  <ul>
                    <li>
                      <a href="/news_detail/news_details_latest/Mg"><img src={NewsImg} alt /></a>
                    ...
                    <li>
                      <a href="/news_detail/news_details_latest/MQ"><img src={NewsImg} alt /></a>
                      <div className="NewsText">
